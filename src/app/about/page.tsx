  ...
  return (
    <section className="bg-white py-12 px-4 max-w-3xl mx-auto">
      ...
      <p className="text-base sm:text-lg text-gray-700 mb-8 text-center max-w-2xl mx-auto">
        PT SINARINDO RAESA ANUGRAH adalah General Contractor & Supplier di bidang Electrical, Maintenance Alat Berat, Konstruksi, dan Engineering. Berlokasi di Gresik – Jawa Timur, perusahaan ini berdiri pada tahun 2025 dengan komitmen menyediakan layanan tenaga kerja dan pengadaan barang yang terintegrasi.
      </p>

      <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 sm:p-6 text-gray-700 space-y-4">
        <h2 className="text-xl sm:text-2xl font-semibold text-red-700 text-center">
          Visi Kami
        </h2>
        ...
        <ul className="list-disc list-inside text-sm sm:text-base max-w-xl mx-auto space-y-2">
